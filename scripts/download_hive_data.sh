...
/google-cloud-sdk/bin/gsutil cp -r gs://sfr-hive-data-research/data/training $SCRIPT_DIR/../data/
...
/google-cloud-sdk/bin/gsutil cp -r gs://sfr-hive-data-research/data/evaluation $SCRIPT_DIR/../data/
